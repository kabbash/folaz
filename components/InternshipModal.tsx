    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="relative w-full max-w-2xl bg-white rounded-lg shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 md:p-8">
          <h2 className="text-[28px] md:text-[32px] font-bold leading-[1.25] text-[#1212a0] mb-4">
            Apply for Internship
          </h2>
          
          <p className="text-[16px] leading-[1.5] text-[#15151c] mb-6">
            Fill out the form below to apply for an internship at Folaz Engineering. Please attach your resume in PDF or DOC format.
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Tell us why you're interested in interning at Folaz Engineering..."
                rows={4}
